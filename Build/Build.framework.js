...
// end include: preamble.js
  ...
  function _ClapMic_IsSupported() {
      var hasNavigator = typeof navigator !== "undefined";
      var mediaDevices = hasNavigator && navigator.mediaDevices;
  ...
  function _JS_Sound_Record_Start(deviceId, soundClipHandle, loop) {
  	...
  	if (microphoneSoundClip && microphoneSoundClip.isRecording) {
  		console.warn(`JS_Sound_Record_Start: device with id ${deviceId} is already recording.`);
  		return;
  	}
  ...
  function _UchiGetAccessToken() {
      var value = "";
      try {
        value = sessionStorage.getItem("uchi.accessToken") || "";
      } catch (e) {
        value = "";
      }
  ...
  function _UchiGetUserId() {
      var value = "";
      try {
        value = sessionStorage.getItem("uchi.userId") || "";
      } catch (e) {
        value = "";
      }
...
var wasmImports = {
  "ClapMic_IsSupported": _ClapMic_IsSupported,
  "ClapMic_Start": _ClapMic_Start,
  "ClapMic_Stop": _ClapMic_Stop,
  "ClapMic_UpdateSettings": _ClapMic_UpdateSettings,
  ...
  "UchiGetAccessToken": _UchiGetAccessToken,
  "UchiGetUserId": _UchiGetUserId,
